...
Використовуйте :point_right:[збудовану версію](https://github.com/UniversalDependencies/UD_Ukrainian-IU/tree/dev), викладену на UD — вона має стандартний стабільний формат.  
