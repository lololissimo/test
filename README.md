...
Використовуйте збудовану версію, [викладену на UD](https://github.com/UniversalDependencies/UD_Ukrainian-IU/tree/dev): вона має стандартний стабільний формат. Працюйте _над_ створенням корпусу тутечки.
